      ...
      {investments.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {investments.map((inv, index) => (
            <div key={inv?.id || index} className="border border-gray-700 rounded-lg p-6 shadow-xl bg-gray-800 transition-transform transform hover:scale-105 hover:shadow-2xl">
              ...
              <p className="mt-2 text-gray-300">Quarterly Revenue: <span className="text-blue-400">{inv?.quarterlyRevenue || "N/A"}</span></p>
              <p className="text-gray-300">Employees: <span className="text-blue-400">{inv?.employees || "N/A"}</span></p>
